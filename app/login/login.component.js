System.register(['angular2/core', './login.service', './login.model', '../auth.service'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, login_service_1, login_model_1, auth_service_1;
    var LoginComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            LoginComponent = (function () {
                function LoginComponent(_loginSevice) {
                    ...
                    if (auth_service_1.AuthService.getInstance().isConnected()) {
                    }
                }
